...
import com.example.anchalsinghal.ecommerce_demo.Adapter.ProductAdapter;
...
public class ProductFragment extends Fragment implements IProduct {

    RecyclerView rv_category;
    List<ProductsItem> productsItemList;
    public RecyclerView.Adapter<ProductAdapter.ViewHolder> madapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle
        ...
        try {
            ...
            if (extras != null) {
                ...
                productsItemList = (List<ProductsItem>) getArguments().getSerializable("ListData");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        madapter = new ProductAdapter(productsItemList,this);
